...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003439134320') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003439134320') 
...
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "just2earn.com")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/EclipseScript') 
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://relative-marten-ritiknew345-7733ed24.koyeb.app/'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://relative-marten-ritiknew345-7733ed24.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "https://flaky-aili-filter-bot-456880b4.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://relative-marten-ritiknew345-7733ed24.koyeb.app/".format(FQDN)
else:
    URL = "https://relative-marten-ritiknew345-7733ed24.koyeb.app/".format(FQDN)
