...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Bot002:Bot002@cluster0665652156.paswdsg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0665652156")
...
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002314687215') # add multiple channels here, separated by single space
...
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "27000"))
