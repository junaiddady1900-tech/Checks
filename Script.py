class script(object):
    ...
    𝐥𝐚𝐭𝐞𝐬𝐭 𝐜𝐨𝐧𝐭𝐞𝐧𝐭 𝐤𝐚 𝐦𝐚𝐳𝐚 𝐮𝐭𝐡𝐚𝐢𝐲𝐞 — 𝐬𝐢𝐫𝐟 𝐡𝐚𝐦𝐚𝐫𝐢 {@FatherMovieMasala_bot}  𝐤𝐞 𝐬𝐚𝐭𝐡!💯
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @botmaster55
...
<b>𝐉𝐨𝐢𝐧 𝐁𝐚𝐛𝐲☞: <a>@ClipMateBhai</a></b>
