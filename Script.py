class script(object):
    START_TXT = """<b>​​​ʜɪɪ {} 👋,🎬𝐀𝐩𝐧𝐢 𝐏𝐚𝐬𝐚𝐧𝐝𝐢𝐝𝐚 𝐌𝐨𝐯𝐢𝐞𝐬 𝐀𝐮𝐫 𝐖𝐞𝐛 𝐒𝐞𝐫𝐢𝐞𝐬 𝐊𝐚 𝐌𝐚𝐳𝐚 𝐋𝐨!🍿
    𝐀𝐛 𝐛𝐢𝐧𝐚 𝐫𝐮𝐤𝐚𝐰𝐚𝐭, 𝐝𝐢𝐫𝐞𝐜𝐭 𝐝𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐚𝐮𝐫
    𝐥𝐚𝐭𝐞𝐬𝐭 𝐜𝐨𝐧𝐭𝐞𝐧𝐭 𝐤𝐚 𝐦𝐚𝐳𝐚 𝐮𝐭𝐡𝐚𝐢𝐲𝐞 — 𝐬𝐢𝐫𝐟 𝐡𝐚𝐦𝐚𝐫𝐢 {@MOVEGOLDEN10}  𝐤𝐞 𝐬𝐚𝐭𝐡!💯
    ✅ 𝐇𝐚𝐫 𝐍𝐚𝐲𝐞 𝐌𝐨𝐯𝐢𝐞 𝐊𝐚 𝐒𝐚𝐛𝐬𝐞 𝐏𝐞𝐡𝐥𝐞 𝐀𝐜𝐜𝐞𝐬𝐬!
    ✅𝐅𝐚𝐬𝐭 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝, 𝐊𝐨𝐢 𝐖𝐚𝐢𝐭 𝐍𝐚𝐡𝐢
    💥𝐏𝐡𝐚𝐥𝐞 𝐢𝐧 𝟑 𝐂𝐡𝐞𝐧𝐧𝐚𝐥 𝐊𝐨 𝐉𝐨𝐢𝐧 𝐤𝐚𝐫𝐨 👇👇👇👇👇 𝐓𝐫𝐲 𝐚𝐠𝐚𝐢𝐧 𝐩𝐞𝐫 𝐜𝐥𝐢𝐜𝐤 𝐤𝐚𝐫𝐨.</b>"""
...
2:- ᴍᴀᴋᴇ <a href=https://t.me/botmaster55</a> ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ.
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/Premium_Jaction/66'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @thunderfyu
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """Fɪʟᴇ Nᴀᴍᴇ📂:<blockquote><b><a>{file_name}</a></b></blockquote>
<b>𝐉𝐨𝐢𝐧 𝐁𝐚𝐛𝐲☞: <a>@movie_pro_1</a></b>
