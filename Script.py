class script(object):
    START_TXT = """<b>​​​ʜɪɪ {} 👋, 
ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴇᴅɪᴀ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ. ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇᴅ ᴀʟʟ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ. ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ 𝖬𝖠𝖨𝖭 𝖢𝖧𝖠𝖭𝖭𝖤𝖫 𝖩𝖮𝖨𝖭 𝖭𝖮𝖶 𝖥𝖠𝖲𝖳 𝖴𝖯𝖣𝖠𝖳𝖤 https://t.me/+IyGqymZL_qtkMTk1 .</b>"""
