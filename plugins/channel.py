...
━━━━━━━━━━━━━━━━━━━
🔍 <b>Search Movies Here:</b> <a href="https://t.me/+qrI-d_DjWlxlM2Zl">🎞️ Power by MG</a>
━━━━━━━━━━━━━━━━━━━

<blockquote>⚡ Powered by <b>@EclipseScript</b></blockquote>"""
...
async def send_movie_update(bot, file_name, caption):
    try:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('MOVIE SEARCH', url=f'https://t.me/+qrI-d_DjWlxlM2Zl')
        ]]
        if poster:
...
async def reaction_handler(client, query):
    try:
        ...
        updated_buttons = [[
            ...
            InlineKeyboardButton('Get File', url=f'https://t.me/+qrI-d_DjWlxlM2Zl')
        ]]
