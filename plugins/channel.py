...
async def send_movie_update(bot, file_name, caption):
   ...
   #     user_reactions[unique_id] = {}        
        ...
        if poster:
            ...
            await bot.send_message(chat_id='-1002314687215'), await bot.send_message(chat_id='-1002314687215'), text=full_caption, reply_markup=InlineKeyboardMarkup(buttons)), text = full_caption, reply_markup=InlineKeyboardMarkup(buttons))    
        else:
